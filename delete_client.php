                                ...
                                <div class="card-body">
                                    <form class="row" method="post" action="">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="password" class="form-control" value="<?php echo $client->getPassword(); ?>" id="password">
                                        </div>
                                                
                                         <div class="mb-2 p-4">
                                           <input class="btn btn-danger" id="delete_client" value="Delete User" type="submit" name="delete_client">     
                                         </div>
