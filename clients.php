                                    ...
                                    <table id="example" class="table responsive sm" style="width:100%">
                                        ...
                                        <tbody>                                            
                                                    ...
                                                    foreach ($client->get_all() as $c){
                                                        ...
                                                        echo "<td> <a href='edit_client.php?id=".$c->getId()."' class ='btn btn-primary'><i class ='fa fa-edit'></i> Edit </a></td>";
                                                        echo "<td> <a href='delete_client.php?id=".$c->getId()."' class ='btn btn-danger'><i class ='fa fa-trash-alt'></i> Delete </a></td>";
                                                        echo " </tr>";
                                                    }
                                                    ?>
                                        </tbody>
