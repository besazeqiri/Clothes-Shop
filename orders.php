                                ...
                                <div class="card-body">
                                    ...
                                    <table id="example" class=" table responsive sm" style="width:100%">
                                        ...
                                        <tbody>
                                           ...
                                           <?php
                                           $order = new Order();
                                           foreach ($order->get_all() as $o){

                                               echo "<tr>";
                                               echo "<td> " . $o->getId()."</td>";
                                               echo "<td> " . $o->getProductId() . "</td>";
                                               echo "<td> " . $o->getClientId() . "</td>";
                                               echo "<td> " . $o->getOrder_date() . "</td>";
                                               echo "<td> <a href='delete_order.php?id=".$o->getId()."' class ='btn btn-danger'><i class ='fa fa-trash-alt'></i> Delete </a></td>";
                                               echo " </tr>";
                                           }
                                           ?>
